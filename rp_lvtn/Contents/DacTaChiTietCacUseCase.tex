...
\subsubsection{Theo dõi thông tin sự kiện}
...
\textbf{Mục đích} & 
Cho phép Ban tổ chức theo dõi các thông tin liên quan đến sự kiện do mình tổ chức được đăng tải lên hệ thống, bao gồm cả thông tin khách hàng mua vé. \\ \hline
\textbf{Điều kiện tiên quyết} & 
- Ban tổ chức đã đăng nhập vào hệ thống. \newline
- Cơ sở dữ liệu có thông tin sự kiện do đơn vị này tổ chức. \\ \hline
\textbf{Điều kiện hậu quyết} & 
Hiển thị toàn bộ danh sách sự kiện hoặc các sự kiện thỏa mãn từ khóa mà ban tổ chức nhập vào thanh tìm kiếm nếu có. \\ \hline
\textbf{Mô tả ngắn gọn} & 
Ban tổ chức đăng nhập vào hệ thống để theo dõi các thông tin liên quan đến sự kiện do mình tổ chức. \\ \hline
\textbf{Quy trình bình thường} &
1. Ban tổ chức đăng nhập thành công vào hệ thống. \newline
2. Ban tổ chức truy cập mục "Event Information" trên thanh sidebar. \newline
3. Hệ thống truy xuất dữ liệu sự kiện trong cơ sở dữ liệu. \newline
4. Hệ thống kiểm tra có sự kiện nào tồn tại không. \newline
5. Nếu có sự kiện tồn tại, hệ thống hiển thị danh sách sự kiện do đơn vị tổ chức đó tổ chức. \newline
6. Ban tổ chức xem các thông tin tổng quan của sự kiện bao gồm poster, tên sự kiện, thời gian diễn ra/kết thúc, địa điểm tổ chức, trạng thái (draft/published/completed/cancelled). \newline
\begin{itemize}
    \item 6a. Ban tổ chức có thể nhập từ khóa vào thanh tìm kiếm rồi nhấn enter hoặc icon search để tìm kiếm nhanh các sự kiện. Hệ thống sẽ hiển thị các sự kiện thỏa mãn từ khóa mà ban tổ chức đã nhập vào nếu có. \newline
    \item 6b. Ban tổ chức có thể nhấn vào icon eye ở cột Action của một sự kiện cụ thể để xem thông chi tiết. Sau khi xem xong nhấn dấu X ở góc phải để đóng trang chi tiết sự kiện và quay về danh sách sự kiện.
    \item 6c. Ban tổ chức có thể nhấn vào icon person ở cột Action của một sự kiện cụ thể để xem thông tin khách hàng đã mua vé sự kiện đó. \\
    Khi xem thông tin khách hàng, ban tổ chức có thể nhấn vào 1 trong 2 nút là Export CSV (Sheet) và Export PDF để tải về máy danh sách thông tin khách hàng mua vé với định dạng đã chọn \\
    Sau khi xem xong, ban tổ chức có thể nhấn dấu X ở góc phải để đóng trang chi tiết khách hàng và quay về danh sách sự kiện.
\end{itemize} \\ \hline
\textbf{Quy trình thay thế} &
5a. Không có sự kiện nào trong cơ sở dữ liệu: \newline
\hspace*{1em}- Hệ thống hiển thị thông báo “No data” \newline
6a. Không có kết quả phù hợp với tìm kiếm: \newline
\hspace*{1em}- Hệ thống hiển thị “No data” \newline
6b, 6c. Ban tổ chức không muốn quay lại danh sách sự kiện: \newline
