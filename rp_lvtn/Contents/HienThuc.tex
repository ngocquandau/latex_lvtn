...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/USER/AIChatBox.png}
        \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/USER/NhapCauHoi.png}
        \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/USER/AISuyNghi.png}
        \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/USER/AIPhanHoi.png}
        \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/Search without result.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/Search with result.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/ViewAllEvent.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/ĐN.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/Đăng ký.png}
    \vspace{15pt}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/USER/Thiếu MK và Email ĐN.png}
        \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/USER/invalid email.png}
        \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/USER/Sai MK.png}
        \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/USER/Thieu TT ĐK.png}
        \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/USER/invalid email ĐK.png}
        \vspace{15pt}
        \caption{Thông báo lỗi khi người dùng nhập email không hợp lệ}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/USER/Sai XT MK ĐK.png}
        \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/Đăng nhập thành công.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/ĐK TC.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.70\textwidth]{Contents/UI/USER/Event Detail.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/cảnh báo độ tuổi.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/thanh toán payos.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/TicketHistory1.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/QR e-ticket.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/e-ticket.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/TicketHistory2.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/US_Rating.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/BTC/BTC ĐN.png}
    \vspace{15pt}
    \caption{Giao diện ban tổ chức nhập thông tin đăng nhập}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/BTC/DL TK BTC.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/BTC/Giao diện BTC.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/BTC/Xem TT SK.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/BTC/List_us.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/BTC/Org_Rating.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/BTC/Thông tin BTC.png}
    \vspace{15pt}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{Contents/UI/BTC/Ban tổ chức - Danh sách sự kiện (1).png}
%     \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/QTV DN.png}
    \vspace{15pt}
    \caption{Giao diện quản trị viên nhập thông tin đăng nhập}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/QTV DN TC.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/DL TK.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/event infor.png}
    \vspace{15pt}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/search event.png}
        \vspace{15pt}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/view selected event.png}
        \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/edit selected event.png}
        \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/delete selected event.png}
        \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/create new event.png}
    \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/tt btc.png}
    \vspace{15pt}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/search btc.png}
    \vspace{15pt}
...
\begin{itemize}
    ...
    % \begin{figure}[H]
    %     \centering
    %     \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/png}
    %     \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/edit btc.png}
        \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/delete btc.png}
        \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/create new btc.png}
    \vspace{15pt}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/create ticket overview.png}
    \vspace{15pt}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/chọn tên sự kiện cần tạo vé.png}
        \vspace{15pt}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/điền tt vé general.png}
            \vspace{15pt}
        ...
        \begin{itemize}
            \item[] \textbf{Lựa chọn 1:} Nhấn nút "Save" ở hình 84 để lưu thông tin vé vừa điền vào bảng vé hiện có của sự kiện.
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/save lưu 1 vé cho general.png}
                \vspace{15pt}
            ...
            \end{figure}
            \item[] \textbf{Lựa chọn 2:} Nhấn nút "Delete" ở hình 84 để xóa thông tin vé vừa điền nếu muốn.
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/tạo nhiều vé general.png}
                \vspace{15pt}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/điền tt vé reserved.png}
            \vspace{15pt}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/điền ds ghế.png}
            \vspace{15pt}
        ...
        Sau khi nhập xong thông tin ghế, cần nhấn nút "OK" để lưu thông tin ghế vào vé và giao diện sẽ quay lại giao diện điền thông tin vé trước đó như ở hình 87 cùng với con số ở nút "Danh sách ghế" đã được thay đổi bằng số lượng ghế vừa điền. Lúc này Quản trị viên có thể thực hiện một trong các lựa chọn sau:
        \begin{itemize}
            \item[] \textbf{Lựa chọn 1:} Nhấn lại nút "Danh sách ghế" của vé trước đó để điền thêm thông tin ghế nếu muốn.
            \item[] \textbf{Lựa chọn 2:} Nhấn nút "Save" ở hình 87 để lưu thông tin vé vừa điền vào bảng vé hiện có của sự kiện.
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/Lưu tt 1 vé reserved.png}
                \vspace{15pt}
                \caption{Giao diện lưu thông tin một vé có chỗ ngồi cố định tại trang quản lý thông tin vé của Quản trị viên}
            \end{figure}
            \item[] \textbf{Lựa chọn 3:} Nhấn nút "Delete" ở hình 87 để xóa thông tin vé vừa điền nếu muốn.
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/Tạo 1 loạt vé reserved.png}
                \vspace{15pt}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/Giao diện bảng vé hiện có.png}
        \vspace{15pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/Quản lý TT KH.png}
    \vspace{15pt}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/search user.png}
    \vspace{15pt}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/detail info user.png}
        \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/edit user.png}
        \vspace{15pt}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{Contents/UI/QTV/delete user.png}
        \vspace{15pt}
