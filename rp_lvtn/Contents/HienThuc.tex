...
\indent - Chức năng thanh toán của hệ thống được liên kết với nền tảng PayOS. Người dùng cần dùng các app ngân hàng hoặc ví điện tử trên điện thoại để quét mã QR và tiến hành thanh toán.\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Contents/UI/USER/buyTicketHistory.png}
    \vspace{15pt}
